...
_C.MODEL.HEADS_NAME = ['']
_C.MODEL.PRETRAINED = r"E:\CnnModel\YOLOP\weights\End-to-end.pth"
...
_C.DATASET.DATAROOT = r'E:\CnnModel\YOLOP\YoloP_data\segmentation\images'       # the path of images folder
_C.DATASET.LABELROOT = r'E:\CnnModel\YOLOP\YoloP_data\segmentation\label'      # the path of det_annotations folder
_C.DATASET.MASKROOT = r'E:\CnnModel\YOLOP\YoloP_data\segmentation\road_label'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = r'E:\CnnModel\YOLOP\YoloP_data\segmentation\lane_label'               # the path of ll_seg_annotations folder
