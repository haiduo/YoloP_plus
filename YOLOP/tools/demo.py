...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default=r'C:\Users\haidu\Desktop\YOLOP\inference\videos\orig_highway_video\DJI_0010.MP4', help='source')  # file/folder   ex:inference/images
