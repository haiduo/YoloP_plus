...
_C.DEBUG = False
_C.num_dect_class = 8  # number of detection class
_C.num_seg_class = 2   # number of segementation class 
...
_C.MODEL.HEADS_NAME = ['']
_C.MODEL.PRETRAINED = r"C:\Users\haidu\Desktop\YOLOP\weights\End-to-end.pth"
_C.MODEL.PRETRAINED_DET = ''
_C.MODEL.IMAGE_SIZE = [640, 640]  # width * height, ex: 192 * 256
_C.MODEL.EXTRA = CN(new_allowed=True)
_C.MODEL.NOT_INIT_MODEL = [False]
...
_C.DATASET.DATAROOT = r'C:\Users\haidu\Desktop\YOLOP\YoloP_data\segmentation\images'       # the path of images folder
_C.DATASET.LABELROOT = r'C:\Users\haidu\Desktop\YOLOP\YoloP_data\segmentation\label'      # the path of det_annotations folder
_C.DATASET.MASKROOT = r'C:\Users\haidu\Desktop\YOLOP\YoloP_data\segmentation\road_label'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = r'C:\Users\haidu\Desktop\YOLOP\YoloP_data\segmentation\lane_label'               # the path of ll_seg_annotations folder
...
_C.TRAIN.ENC_DET_ONLY = False        # Only train detection task 
_C.TRAIN.PLOT = False                # Plot detected boxs of images
