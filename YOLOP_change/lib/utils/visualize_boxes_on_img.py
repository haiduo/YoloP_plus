...
def visualize_boxes(image,boxes,classes,scores, instance_masks=None,instance_boundaries=None,use_normalized_coordinates=False,
        max_boxes_to_draw=200, min_score_thresh=0.4, agnostic_mode=False, line_thickness=4,
  ...
  for i in range(min(max_boxes_to_draw, boxes.shape[0])):
    ...
    #   print("boxes[{}]:{}".format(i, boxes[i]))
      ...
      if scores is None:
        ...
        # print(type(box), box, type(display_str), display_str)
...
if __name__ == '__main__':
    img_dir = r'C:\Users\haidu\Desktop\temp\VisDrone2019-DET_resize\train\images'
    anno_dir = r'C:\Users\haidu\Desktop\temp\VisDrone2019-DET_resize\train\annotations' 
    output_dir = r'C:\Users\haidu\Desktop\temp\visualize'
